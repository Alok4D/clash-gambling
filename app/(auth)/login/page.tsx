...
const LoginPage = () => {
  return (
    <div className="min-h-screen w-full bg-[#0B0E11] text-white selection:bg-[#00FFA3]/30">
      <div className="mx-auto flex min-h-screen max-w-[1440px] flex-col px-6 py-8 lg:px-20">
        
        {/* Back to Home Button */}
        <Link 
          href="/" 
          className="group flex w-fit items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm transition-all hover:border-white/20 hover:bg-white/10"
        >
          <ChevronLeft size={16} />
          Back to home
        </Link>
